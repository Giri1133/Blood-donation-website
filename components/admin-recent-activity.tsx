  ...
  const activities = [
    {
      ...
      description: "John D. registered as O+ donor in New York",
      time: "5 minutes ago",
      icon: UserPlus,
    },
    {
      ...
      description: "City General Hospital posted urgent O- request",
      time: "12 minutes ago",
      icon: AlertCircle,
    },
    {
      ...
      description: "Sarah M. donated A- at Central Blood Bank",
      time: "1 hour ago",
      icon: Droplet,
    },
    {
      ...
      description: "Emily T. registered as AB+ recipient in LA",
      time: "2 hours ago",
      icon: UserPlus,
    },
    {
      ...
      description: "Metro Blood Center updated stock levels",
      time: "3 hours ago",
      icon: Building2,
    },
  ]
